...
function buildSystemPrompt(opts = {}) {
  ...
  return [
    ...
    `   На вопрос «когда работает / какой график у мастера» — get_available_dates (поле schedule_dates — рабочие дни; bookable_dates — дни со свободной записью). Свободное время на конкретную дату — get_available_slots.`,
