...
// достоверная карта услуга→мастера (per-staff запросами, а не урезанным s.staff).
...
describe('list_services', () => {
  test('активные услуги + достоверные мастера (per-staff), неактивные отфильтрованы', async () => {
    db.any
